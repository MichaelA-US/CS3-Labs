 ...
 * The main Exceptions are IOException and RunTimeException
 * IOExceptions are used for exceptions beyond your control (e.g. the disk is full)
 * RunTimeExceptions indicate programmer error (e.g. you tried to write past the end of an array)
 */
public class Exceptions102
{
	 ...
	 * that exception is caught. Checked exceptions that are not monitored
	 * by a try/catch block
	 * 
	 * You msut mark your method to indicate that it throws this exception 
	 */
