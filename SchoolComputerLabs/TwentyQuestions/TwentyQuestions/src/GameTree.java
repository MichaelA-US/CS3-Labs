...
public class GameTree
{
	 ...
	 */
		//TODO?
	/**
	 * Inner class TreeNode that instantiates
	 * the binary tree
	 */
	private class TreeNode
	{
		...
		TreeNode right;
		/**
		 * Basic constructor that initializes each tree side
		 * @param data - the value of each tree side
		 */
		...
		/**
		 * Basic constructor that initializes each tree side left and right
		 * @param data - vals for side
	...
	public GameTree(String fileName) 
	{
		...
		} catch (FileNotFoundException e) 
		{
			...
			tempRoot = createTree(); //instantiating the tree
			root = tempRoot; //setting a temp tree ^^ for clear later on
			scan.close();
	}
